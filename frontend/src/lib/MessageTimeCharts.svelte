<script>
  ...
  function renderCharts() {
    ...
    charts.push(
      makeChart(hourCanvas, "messages by hour", hourEntries, "rgba(56, 189, 248, 0.8)")
    );
    charts.push(
      makeChart(dayCanvas, "messages by day", dayEntries, "rgba(45, 212, 191, 0.8)")
    );
    charts.push(
      makeChart(monthCanvas, "messages by month", monthEntries, "rgba(96, 165, 250, 0.8)")
    );
    charts.push(
      makeChart(yearCanvas, "messages by year", yearEntries, "rgba(16, 185, 129, 0.8)")
    );
  }
